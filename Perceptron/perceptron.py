...
print(
    f"Perceptron Classification Accuracy = {accuracy_score(y_true=y_test, y_pred=pred)} \n")
...
x1_1 = (-model_perceptron.weights[0] * x0_1 -
        model_perceptron.bias) / model_perceptron.weights[1]
x1_2 = (-model_perceptron.weights[0] * x0_2 -
        model_perceptron.bias) / model_perceptron.weights[1]
